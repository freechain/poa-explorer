defmodule ExplorerWeb.TransactionControllerTest do
  ...
  describe "GET index/3" do
    ...
    test "returns internal transactions for the address", %{conn: conn} do
      ...
      from_internal_transaction = insert(:internal_transaction, transaction_id: transaction.id, from_address_id: address.id)
      ...
      actual_transaction_ids = conn.assigns.page
